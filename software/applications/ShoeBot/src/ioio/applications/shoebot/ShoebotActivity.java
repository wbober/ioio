...
public class ShoebotActivity extends IOIOActivity implements
	...
	private class Stepper {
		private final DigitalOutput dir_;
		private final PwmOutput stp_;
		private final DigitalOutput slp_;
	
		public Stepper(IOIO ioio, int startPin) throws ConnectionLostException {
			dir_ = ioio.openDigitalOutput(startPin, false);
			stp_ = ioio.openPwmOutput(startPin + 1, 4);
	...
	class BalancerLooper extends BaseIOIOLooper {
		...
		public void setup() throws ConnectionLostException {
			...
			steppers_[0] = new Stepper(ioio_, 2);
			steppers_[1] = new Stepper(ioio_, 13);
			errorInt_ = 0;
